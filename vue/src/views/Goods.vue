<template>
  <div style="padding: 10px">
    ...
    <div style="margin: 10px 0">
      <el-button type="primary" @click="add" v-if="user.role=== '老板'">新增</el-button>
    </div>
    <!--    搜索区域-->
    <div style="margin: 10px 0">
      <el-input v-model="search" placeholder="输入甜品关键字"
    ...
    <el-table :data= "tableData" border stripe style="width: 100%;">
      ...
      <el-table-column prop="author" label="制作员工" />
      <el-table-column prop="createtime" label="出产日期" />
      <el-table-column prop="enddate" label="保质期时间/天" />
      ...
      <el-table-column fixed="right" label="操作" width="120">
        <template #default="scope">
          <el-button link type="primary"
                     size="small" @click="handleEdit(scope.row)" v-if="user.role=== '老板'">
            编辑</el-button
          >
          <el-popconfirm title="你确定要删除吗?" @confirm="handleDelete(scope.row.id)" v-if="user.role=== '老板' ">
            <template #reference>
    ...
    <div style="margin:10px 0">
      ...
      <el-dialog v-model="dialogVisible" title="Tips" width="30%">
        <el-form :model="form" label-width="12 0px">
          ...
          <el-form-item label="保质期时间/天">
            <el-input v-model="form.enddate" style="width:80%"></el-input>
          </el-form-item>
        </el-form>
        <template #footer>
