  ...
  <div style="padding: 10px">
    ...
    <el-table :data= "tableData" border stripe style="width: 100%;">
      <el-table-column prop="id" label="订单ID"
                       sortable />
      <el-table-column prop="userid" label="采购员ID"
                       sortable />
      <el-table-column prop="name" label="原料名称"/>
      <el-table-column prop="price" label="原料价格/元" />
      <el-table-column prop="number" label="原料数量/kg"
                       sortable />
      <el-table-column prop="buydate" label="购买日期" />
      <el-table-column prop="startdate" label="生产日期" />
    ...
    <div style="margin:10px 0">
      ...
      <el-dialog v-model="dialogVisible" title="Tips" width="30%">
        <el-form :model="form" label-width="12 0px">
          ...
          <el-form-item label="原料价格/元">
            <el-input v-model="form.price" style="width:80%"></el-input>
          </el-form-item>
          <el-form-item label="原料数量/kg">
          ...
          <el-form-item label="购买日期">
            <el-date-picker value-format="YYYY-MM-DD" type="date" v-model="form.buydate" style="width:80%" clearable></el-date-picker>
          </el-form-item>
          <el-form-item label="生产日期">
            <el-date-picker value-format="YYYY-MM-DD" type="date" v-model="form.startdate" style="width:80%" clearable></el-date-picker>
          </el-form-item>
          <el-form-item label="过期时间">
            <el-date-picker value-format="YYYY-MM-DD" type="date" v-model="form.enddate" style="width:80%" clearable></el-date-picker>
          </el-form-item>
        </el-form>
        <template #footer>
